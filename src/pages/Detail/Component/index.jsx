 ...
 function ProductReview({todo}) {
    ...
    return (
                ...
                <>
                    ...
                    <div className="container__feedback" style={{backgroundColor: "#EEEEEE",borderRadius: "0.25rem" ,padding:" 1px 3px 3px 7px " , marginTop:"10px"}}>
                    ...
                    <div className="container__feedback__title">
                        ...
                        <h6>
                            <strong>Nhận xét:</strong> Đẹp,Giao hàng nhanh
                        </h6>
                    </div>
                    </div>
